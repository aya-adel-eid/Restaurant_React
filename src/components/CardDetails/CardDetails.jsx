    ...
    <>
      <section className="p-10">
        <div>
            ...
            <div className="lg:col-span-4">
              <div className="border-b border-b-gray-200 py-8 ">
                ...
                <div className="bg-red-100 rounded-full px-4 py-2 text-red-700 font-bold flex w-fit items-center justify-center gap-x-1.5">
                  ...
                  <span>{mealDeatils?.productCategory?.displayName}</span>
                </div>
                {/* title */}
                <h2 className="text-2xl py-6 lg:text-4xl font-bold leading-5 tracking-wide">
                  {mealDeatils?.productName}
                </h2>
                {/* stars */}
                <div className="space-x-1.5 py-4">
                  <span>
                    <i class="fa-solid fa-star text-yellow-300 lg:text-lg"></i>
                  </span>
                  <span>
                    <i class="fa-solid fa-star text-yellow-300 lg:text-lg"></i>
                  </span>
                  ...
                  <span>
                    <i class="fa-solid fa-star-half-stroke text-yellow-300 lg:text-lg"></i>
                  </span>
                ...
                {/* price */}
                <h3 className="text-main-500 lg:text-3xl font-bold py-1.5">
                  $ {mealDeatils?.productPrice}
                </h3>
                {/* description */}
                <p className="text-lg text-gray-400 leading-6 pt-2">
                  {mealDeatils?.productDescription}
                </p>
              </div>
              <div>
                ...
                <div className="flex flex-col lg:flex-row  lg:items-center lg:justify-between py-4 gap-3">
                  ...
                  <button className="bg-main-500 text-white py-2 px-4 rounded-full">
          ...
          {/* RelatedMeals */}
          <div>
            <h2 className="text-main-500 text-xl lg:text-2xl py-4 font-semibold">
              Related Product
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2  lg:grid-cols-4 py-4 gap-4">
              {relatedMeal?.map((meal) => (
                <div className="flex justify-center items-center bg-white p-4 gap-4 shadow-lg rounded-4xl">
                  <img
                    src={meal.imageUrl}
                  ...
                  <div>
                    ...
                    <span className="text-main-500 font-semibold text-lg">
                      {meal.productPrice}
                    </span>
                  </div>
                </div>
